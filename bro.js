(function () {
  ...
  var personalityCopy = {
    normal: {
      ...
      celebrateTitle: "Bro recognizes every completion.",
      celebrateBody: "Finish early, right on time, or after the deadline—Normal mode simply confirms that the task is complete.",
      ...
      promoLabel: "Limited-time launch sale",
      promoTitle: "Pre-order Bro for $1.99.",
      promoBody: "Get in early and save on the regular $4.99 price. This introductory pre-order offer ends September 30, 2026.",
      promoPriceLabel: "Pre-order price",
      promoButton: "Pre-order for $1.99",
      ctaTitle: "Ready to do the thing?",
      ctaBody: "Pre-order Bro now on the App Store. The FAQ and support pages have the practical details while you wait for release day.",
    },
    casual: {
      ...
      promoLabel: "Launch deal, Bro",
      promoTitle: "Grab Bro for $1.99.",
      promoBody: "Get in early for $1.99 instead of the regular $4.99 price. The pre-order deal ends September 30, 2026.",
      promoPriceLabel: "Early-Bro price",
      promoButton: "Get the $1.99 deal",
      ctaTitle: "Alright, ready to do the thing?",
      ctaBody: "Pre-orders are open now on the App Store. The FAQ and support pages have the useful details while you wait for release day.",
    },
    genz: {
      ...
      promoLabel: "Launch price just dropped",
      promoTitle: "Pre-order for $1.99. Huge W.",
      promoBody: "Bro is normally $4.99, but early birds can lock in the $1.99 pre-order price through September 30, 2026.",
      promoPriceLabel: "Pre-order W",
      promoButton: "Lock in $1.99",
      ctaTitle: "Ready to lock in?",
      ctaBody: "The pre-order is live on the App Store. Lock it in now, then hit the FAQ and support pages for the full lore.",
    },
    unhinged: {
      ...
      promoLabel: "THE LAUNCH SALE HAS ARRIVED",
      promoTitle: "BRO IS $1.99. ACT IMMEDIATELY.",
      promoBody: "THE REGULAR PRICE IS $4.99. PRE-ORDER FOR $1.99 THROUGH SEPTEMBER 30, 2026, BEFORE THE CLOCK CONSUMES THIS OFFER.",
      promoPriceLabel: "THE LAUNCH PRICE",
      promoButton: "SECURE BRO FOR $1.99",
      ctaTitle: "THE TASKS ARE WAITING.",
      ctaBody: "PRE-ORDERS ARE OPEN ON THE APP STORE. SECURE BRO. CONSULT THE FAQ. PREPARE YOUR TASKS. WE ARE GOING TO DO THE THING.",
    },
  };
  var welcomeCopy = {
